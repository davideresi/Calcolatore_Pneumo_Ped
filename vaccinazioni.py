...
def main(data_nascita, eta_mesi, categoria, ha_vaccinazioni, dosi_precedenti):
    ...
    # --- Bambini con eta_mesi 7-11 ---
            ...
            if n_dosi == 1:
                ...
                st.info("➕ Completare con 2 dosi di PCV20: 1 dose a distanza di almeno 4-8 settimane, poi richiamo tra 10-15 mesi")
                ...
                if all(e < 7 for e in eta_dosi):
                    ...
                    st.info("➕ Completare con 1 dose di PCV20 tra 10-15 mesi a distanza di almeno 8 settimane dall'ultima dose")
...
def normalizza_tipo_ciclo(tipo_dosi):
    if "PCV20" in tipo_dosi:
        if "PCV15" in tipo_dosi:
            return "Misto-PCV20"  # ciclo misto, regole PCV20
        else:
            return "PCV20"
    elif all(v == "PCV15" for v in tipo_dosi):
        return "PCV15"
    else:
        return "Altro"  # eventuali casi da gestire
